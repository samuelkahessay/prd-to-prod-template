...
echo "     - Verify with: bash scripts/verify-repo-protection.sh"
echo ""
echo "  3. Submit your first PRD:"
echo "     Create an issue with your product requirements."
echo "     For multi-issue or risky work, comment /plan, then /approve-architecture,"
echo "     then /decompose."
